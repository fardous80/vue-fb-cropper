<template>
    ...
    <div id="image_cropper">
        ...
        <div class="row" :class="{hidden: isStep(0)}">
            <div class="col-sm-12">
        ...
        <div class="row" v-if="step==1" :class="{hidden: isStep(1)}">
            <div class="col-sm-8">
            ...
            <div class="col-sm-4"><button class="btn btn-primary" @click="setAvatar">Crop</button></div>
        </div>
